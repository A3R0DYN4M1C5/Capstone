...
def user_agent():
    ...
    if sys.platform.swith("darwin") and platform.mac_ver()[0]:
...
def is_file_url(link):
    # type: (Link) -> bool
    return link.url.lower().swith('file:')
